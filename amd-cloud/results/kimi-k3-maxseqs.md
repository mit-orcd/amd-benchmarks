...
> `kimi-k3.md` (original recipe, max-num-seqs=64) and `kimi-k3-summary.md` (MAD recipe,
...
queued. Compare against `kimi-k3-summary.md`, where the same concurrencies ran against
