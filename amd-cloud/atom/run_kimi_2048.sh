...
PORT="${PORT:-8018}"
MAXSEQS="${MAXSEQS:-2048}"
CONC="${MAXSEQS_CONC:-512 1024 2048}"
ISL="${ISL:-1024}"; OSL="${OSL:-1024}"
NAME="atom-kimi-2048"

TS=$(date +%Y%m%d_%H%M%S)
OUT=$LOG_ROOT/atom/kimi_2048_$TS; mkdir -p "$OUT"
STATE=$OUT/STATE.txt
...
say "generating results/kimi-k3-maxseqs2048.md"
$PY analyze_kimi_2048.py "$OUT" -o "$BENCH_ROOT/results" >"$OUT/analyze.log" 2>&1
say "analyze rc=$? -> $BENCH_ROOT/results/kimi-k3-maxseqs2048.md"
