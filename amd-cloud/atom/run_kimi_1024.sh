...
PORT="${PORT:-8016}"
MAXSEQS="${MAXSEQS:-1024}"
CONC="${MAXSEQS_CONC:-256 512 1024}"
ISL="${ISL:-1024}"; OSL="${OSL:-1024}"
NAME="atom-kimi-1024"

TS=$(date +%Y%m%d_%H%M%S)
OUT=$LOG_ROOT/atom/kimi_1024_$TS; mkdir -p "$OUT"
STATE=$OUT/STATE.txt
...
say "generating results/kimi-k3-maxseqs1024.md"
$PY analyze_kimi_1024.py "$OUT" -o "$BENCH_ROOT/results" >"$OUT/analyze.log" 2>&1
say "analyze rc=$? -> $BENCH_ROOT/results/kimi-k3-maxseqs1024.md"
